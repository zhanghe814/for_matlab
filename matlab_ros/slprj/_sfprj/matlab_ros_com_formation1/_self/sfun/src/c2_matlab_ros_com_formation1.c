...
static void initialize_c2_matlab_ros_com_formation1
  (SFc2_matlab_ros_com_formation1InstanceStruct *chartInstance);
static void initialize_params_c2_matlab_ros_com_formation1
  (SFc2_matlab_ros_com_formation1InstanceStruct *chartInstance);
static void enable_c2_matlab_ros_com_formation1
  (SFc2_matlab_ros_com_formation1InstanceStruct *chartInstance);
static void disable_c2_matlab_ros_com_formation1
  (SFc2_matlab_ros_com_formation1InstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_matlab_ros_com_formation1
  (SFc2_matlab_ros_com_formation1InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_matlab_ros_com_formation1
  (SFc2_matlab_ros_com_formation1InstanceStruct *chartInstance);
static void set_sim_state_c2_matlab_ros_com_formation1
  (SFc2_matlab_ros_com_formation1InstanceStruct *chartInstance, const mxArray
   *c2_st);
static void finalize_c2_matlab_ros_com_formation1
  (SFc2_matlab_ros_com_formation1InstanceStruct *chartInstance);
static void sf_gateway_c2_matlab_ros_com_formation1
  (SFc2_matlab_ros_com_formation1InstanceStruct *chartInstance);
static void mdl_start_c2_matlab_ros_com_formation1
  (SFc2_matlab_ros_com_formation1InstanceStruct *chartInstance);
static void c2_chartstep_c2_matlab_ros_com_formation1
  (SFc2_matlab_ros_com_formation1InstanceStruct *chartInstance);
static void initSimStructsc2_matlab_ros_com_formation1
  (SFc2_matlab_ros_com_formation1InstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_emlrt_marshallOut
  (SFc2_matlab_ros_com_formation1InstanceStruct *chartInstance, const uav *c2_u);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static void c2_emlrt_marshallIn(SFc2_matlab_ros_com_formation1InstanceStruct
  *chartInstance, const mxArray *c2_b_uav3_des, const char_T *c2_identifier, uav
  *c2_y);
static void c2_b_emlrt_marshallIn(SFc2_matlab_ros_com_formation1InstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  uav *c2_y);
static real_T c2_c_emlrt_marshallIn(SFc2_matlab_ros_com_formation1InstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
...
static uint8_T c2_g_emlrt_marshallIn
  (SFc2_matlab_ros_com_formation1InstanceStruct *chartInstance, const mxArray
   *c2_b_is_active_c2_matlab_ros_com_formation1, const char_T *c2_identifier);
static uint8_T c2_h_emlrt_marshallIn
  (SFc2_matlab_ros_com_formation1InstanceStruct *chartInstance, const mxArray
   *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_matlab_ros_com_formation1InstanceStruct
  *chartInstance);
  ...
  (SFc2_matlab_ros_com_formation1InstanceStruct *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc2_matlab_ros_com_formation1(chartInstance);
    chart_debug_initialize_data_addresses(chartInstance->S);
  }

  chartInstance->c2_sfEvent = CALL_EVENT;
  _sfTime_ = sf_get_time(chartInstance->S);
  chartInstance->c2_is_active_c2_matlab_ros_com_formation1 = 0U;
}
  ...
  (SFc2_matlab_ros_com_formation1InstanceStruct *chartInstance)
{
  ...
  c2_hoistedGlobal = chartInstance->c2_is_active_c2_matlab_ros_com_formation1;
  c2_b_y = NULL;
   ...
   *c2_st)
{
  ...
  *(real_T *)&((char_T *)chartInstance->c2_uav3_des)[64] = c2_r7.angularz;
  chartInstance->c2_is_active_c2_matlab_ros_com_formation1 =
    c2_g_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 4)),
    "is_active_c2_matlab_ros_com_formation1");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_matlab_ros_com_formation1(chartInstance);
  ...
  (SFc2_matlab_ros_com_formation1InstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_matlab_ros_com_formation1(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_matlab_ros_com_formation1MachineNumber_,
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  SFc2_matlab_ros_com_formation1InstanceStruct *chartInstance;
  chartInstance = (SFc2_matlab_ros_com_formation1InstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c2_matlab_ros_com_formation1_get_eml_resolved_functions_info
  (void)
{
   ...
   *c2_b_is_active_c2_matlab_ros_com_formation1, const char_T *c2_identifier)
{
  ...
  c2_y = c2_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_matlab_ros_com_formation1), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_matlab_ros_com_formation1);
  return c2_y;
}
...
void sf_c2_matlab_ros_com_formation1_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1617993095U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(4293555282U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2153724708U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2983065100U);
}

mxArray* sf_c2_matlab_ros_com_formation1_get_post_codegen_info(void);
mxArray *sf_c2_matlab_ros_com_formation1_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("yB2IVL86waQV9f1shLJGUB");
...

  {
    mxArray* mxPostCodegenInfo =
      sf_c2_matlab_ros_com_formation1_get_post_codegen_info();
...
mxArray *sf_c2_matlab_ros_com_formation1_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_matlab_ros_com_formation1_jit_fallback_info(void)
{
...
mxArray *sf_c2_matlab_ros_com_formation1_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c2_matlab_ros_com_formation1(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[5],T\"uav0_des\",},{M[1],M[9],T\"uav1_des\",},{M[1],M[10],T\"uav2_des\",},{M[1],M[11],T\"uav3_des\",},{M[8],M[0],T\"is_active_c2_matlab_ros_com_formation1\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_matlab_ros_com_formation1_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc2_matlab_ros_com_formation1InstanceStruct *chartInstance =
      (SFc2_matlab_ros_com_formation1InstanceStruct *)sf_get_chart_instance_ptr
      (S);
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        init_script_number_translation(_matlab_ros_com_formation1MachineNumber_,
          chartInstance->chartNumber,chartInstance->instanceNumber);
        if (chartAlreadyPresent==0) {
          /* this is the first instance */
          sf_debug_set_chart_disable_implicit_casting
            (sfGlobalDebugInstanceStruct,
             _matlab_ros_com_formation1MachineNumber_,chartInstance->chartNumber,
             1);
...
{
  return "sScKktGOfmc4eHC1Ej76gOB";
}

static void sf_opaque_initialize_c2_matlab_ros_com_formation1(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_matlab_ros_com_formation1InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_matlab_ros_com_formation1
    ((SFc2_matlab_ros_com_formation1InstanceStruct*) chartInstanceVar);
  initialize_c2_matlab_ros_com_formation1
    ((SFc2_matlab_ros_com_formation1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_matlab_ros_com_formation1(void *chartInstanceVar)
{
  enable_c2_matlab_ros_com_formation1
    ((SFc2_matlab_ros_com_formation1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_matlab_ros_com_formation1(void
  *chartInstanceVar)
{
  disable_c2_matlab_ros_com_formation1
    ((SFc2_matlab_ros_com_formation1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_matlab_ros_com_formation1(void
  *chartInstanceVar)
{
  sf_gateway_c2_matlab_ros_com_formation1
    ((SFc2_matlab_ros_com_formation1InstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c2_matlab_ros_com_formation1
  (SimStruct* S)
{
  return get_sim_state_c2_matlab_ros_com_formation1
    ((SFc2_matlab_ros_com_formation1InstanceStruct *)sf_get_chart_instance_ptr(S));/* raw sim ctx */
}

static void sf_opaque_set_sim_state_c2_matlab_ros_com_formation1(SimStruct* S,
  const mxArray *st)
{
  set_sim_state_c2_matlab_ros_com_formation1
    ((SFc2_matlab_ros_com_formation1InstanceStruct*)sf_get_chart_instance_ptr(S),
     st);
}

static void sf_opaque_terminate_c2_matlab_ros_com_formation1(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_matlab_ros_com_formation1InstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c2_matlab_ros_com_formation1
      ((SFc2_matlab_ros_com_formation1InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_matlab_ros_com_formation1
    ((SFc2_matlab_ros_com_formation1InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_matlab_ros_com_formation1(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_matlab_ros_com_formation1(SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_matlab_ros_com_formation1_optimization_info
  ...
  ssSetChecksum0(S,(1330353778U));
  ssSetChecksum1(S,(670640486U));
  ssSetChecksum2(S,(1146017149U));
  ssSetChecksum3(S,(569097285U));
...
static void mdlRTW_c2_matlab_ros_com_formation1(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_matlab_ros_com_formation1(SimStruct *S)
{
  SFc2_matlab_ros_com_formation1InstanceStruct *chartInstance;
  chartInstance = (SFc2_matlab_ros_com_formation1InstanceStruct *)utMalloc
    (sizeof(SFc2_matlab_ros_com_formation1InstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc2_matlab_ros_com_formation1InstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 1;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_matlab_ros_com_formation1;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_matlab_ros_com_formation1;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_matlab_ros_com_formation1;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_matlab_ros_com_formation1;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_matlab_ros_com_formation1;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_matlab_ros_com_formation1;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_matlab_ros_com_formation1;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_matlab_ros_com_formation1;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_matlab_ros_com_formation1;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_matlab_ros_com_formation1;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_matlab_ros_com_formation1;
  ...
  mdl_start_c2_matlab_ros_com_formation1(chartInstance);
}

void c2_matlab_ros_com_formation1_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_matlab_ros_com_formation1(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_matlab_ros_com_formation1(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_matlab_ros_com_formation1(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_matlab_ros_com_formation1_method_dispatcher.\n"
